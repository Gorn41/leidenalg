...
foreach(_cmake_expected_target IN ITEMS libleidenalg)
...
add_library(libleidenalg SHARED IMPORTED)

set_target_properties(libleidenalg PROPERTIES
  INTERFACE_LINK_LIBRARIES "igraph::igraph"
)
...
if(NOT CMAKE_VERSION VERSION_LESS "3.23.0")
  ...
  set_property(TARGET libleidenalg
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/libleidenalgTargets-*.cmake")
