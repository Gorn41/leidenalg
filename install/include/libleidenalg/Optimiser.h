...
class LIBLEIDENALG_EXPORT Optimiser
{
  public:
    ...
    double optimise_partition_hierarchical(vector<MutableVertexPartition*> partitions, vector<double> layer_weights, vector<bool> const& is_membership_fixed, vector<MutableVertexPartition*>& hierarchy);
